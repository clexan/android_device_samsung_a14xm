...
BOARD_RECOVERY_RAMDISK_KERNEL_MODULES_LOAD := $(strip $(shell cat $(KERNEL_PATH)/modules/modules.load.recovery))
...
BOARD_RECOVERY_RAMDISK_KERNEL_MODULES := $(addprefix $(BOARD_KERNEL_MODULE_DIR)/,$(BOARD_RECOVERY_RAMDISK_KERNEL_MODULES_LOAD))

# Legacy Makefile option needed
# to properly pack the recovery modules
BOARD_RECOVERY_KERNEL_MODULES := $(BOARD_RECOVERY_RAMDISK_KERNEL_MODULES)
BUILD_BROKEN_DUP_RULES := true

# Partitions
BOARD_FLASH_BLOCK_SIZE := 262144  
BOARD_BOOTIMAGE_PARTITION_SIZE := 33554432
BOARD_DTBOIMG_PARTITION_SIZE := 55792
